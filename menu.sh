...
echo -e " [${GREEN}05${NC}]${BLUE} •${NC} Cek Bandwidth Vps$NC    [${GREEN}15${NC}]${BLUE} • ${NC}Cek Speedtest $NC"
...
echo -e " [${GREEN}08${NC}]${BLUE} •${NC} Renew Certv2ray $NC     [${GREEN}18${NC}]${BLUE} • ${NC}Ram $NC"
