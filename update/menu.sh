...
echo -e " [${GREEN}02${NC}]${BLUE} •${NC} Vmess & Vless $NC       [${GREEN}10${NC}]${BLUE} • ${NC}Info Port Install $NC"
echo -e " [${GREEN}03${NC}]${BLUE} •${NC} Trojan $NC              [${GREEN}11${NC}]${BLUE} • ${NC}Info Auto Install $NC"
